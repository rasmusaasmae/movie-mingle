...
export const movies = pgTable('movies', {
  ...
  belongsToCollectionId: integer('belongs_to_collection_id'),
  belongsToCollectionName: text('belongs_to_collection_name'),
  belongsToCollectionPosterPath: text('belongs_to_collection_poster_path'),
  belongsToCollectionBackdropPath: text('belongs_to_collection_backdrop_path'),
